...
export const listings: Listing[] = [
  ...
  { id: 'l3', sellerId: 's2', title: 'Air Jordan 1 Retro High', description: 'Chicago colourway, authentic with box and extra laces. Light creasing on toe box.', priceINR: 8999, category: 'sneakers', size: 'UK9', condition: 'like-new', imageKind: 'photo', photo: '/photos/l3.jpg', gradient: ['#B91C1C', '#111827'], emoji: '👟', likes: 58, status: 'sold', createdAgo: '1d' },
  ...
  { id: 'l7', sellerId: 's4', title: 'Sony PS5 DualSense Controller', description: 'Barely used, no stick drift, comes with original box and cable.', priceINR: 3999, category: 'electronics', condition: 'like-new', imageKind: 'photo', photo: '/photos/l7.jpg', gradient: ['#4338CA', '#0F172A'], emoji: '🎮', likes: 41, status: 'live', createdAgo: '1d' },
  ...
  { id: 'l9', sellerId: 's8', title: "Levi's Denim Jacket", description: 'Classic trucker jacket, medium wash, broken in perfectly. No rips or stains.', priceINR: 1799, category: 'men', size: 'M', condition: 'good', imageKind: 'photo', photo: '/photos/l9.jpg', gradient: ['#1E3A8A', '#93C5FD'], emoji: '🧥', likes: 33, status: 'live', createdAgo: '8h' },
  ...
  { id: 'l19', sellerId: 's2', title: 'Adidas Ultraboost Sneakers', description: 'Ultraboost 21, worn a handful of runs, boost cushioning still springy.', priceINR: 6499, category: 'sneakers', size: 'UK10', condition: 'like-new', imageKind: 'photo', photo: '/photos/l19.jpg', gradient: ['#F8FAFC', '#111827'], emoji: '👟', likes: 44, status: 'sold', createdAgo: '3d' },
  ...
  { id: 'l22', sellerId: 's10', title: 'Logitech Gaming Mouse', description: 'Logitech G302, unused, still sealed, extra weight kit included.', priceINR: 1999, category: 'electronics', condition: 'new', imageKind: 'photo', photo: '/photos/l22.jpg', gradient: ['#111827', '#22C55E'], emoji: '🖱️', likes: 16, status: 'live', createdAgo: '9h' },
